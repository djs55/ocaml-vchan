...
(* OASIS_START *)
(* DO NOT EDIT (digest: 2865a9160b86a349ce3198b3d15650a1) *)
(*
...
let setup_t =
  {
            ...
            [
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("xen-evtchn.inheap", None);
                           FindlibPackage ("xen-gnt", None);
                           FindlibPackage ("xen-gnt.inheap", None)
                        ];
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Vchan_lwt_io"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "vchan";
                      lib_findlib_name = Some "lwt_io";
                      lib_findlib_containers = []
                   });
               Library
                 ({
                     cs_name = "vchan_xenctrl";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                        ...
                        [
                           ...
                           FindlibPackage
                             ("xen-evtchn",
                               Some (OASISVersion.VGreaterEqual "1.0.3"));
                           FindlibPackage ("xen-evtchn.unix", None);
                           FindlibPackage ("xen-evtchn.xenctrl", None);
                           FindlibPackage ("io-page.unix", None);
                           FindlibPackage ("xen-gnt", None);
                           FindlibPackage ("xen-gnt.unix", None);
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Unix_configuration"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "vchan";
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage
                             ("xen-evtchn.xen",
                               Some (OASISVersion.VGreaterEqual "1.0.5"));
                           FindlibPackage
                             ("xen-gnt.xen",
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("lwt", None);
                           InternalLibrary "vchan";
                           InternalLibrary "vchan_xenctrl";
                           FindlibPackage ("xen-evtchn.xenctrl", None);
                           FindlibPackage ("xen-gnt.xenctrl", None);
                           InternalLibrary "cli"
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "unixcat.ml"});
               Doc
                 ({
                     cs_name = "api";
                     cs_data = PropList.Data.create ();
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "Rc\017\136ÿjIA³|Ô3(\002Y¿";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
